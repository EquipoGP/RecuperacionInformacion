...
public class SpatialQuery {
	...
	public static void main(String[] args) {
		...
		String[] bbQueries = {"spatial:-180.0,180.0,-90.0,90.0",
							"spatial:-15.6,6.6,35.0,44.7",
							"spatial:-15.6,6.6,50.0,72.0",
							"spatial:-135.0,-110.0,50.0,72.0"};
	...
	private static void bbQueryParser(String bbQuery) {
		try {
			...
			if (terms[0].equals("spatial")) {
				...
				NumericRangeQuery<Double> westRangeQuery = NumericRangeQuery.newDoubleRange("west", null, e, true, true);
				NumericRangeQuery<Double> eastRangeQuery = NumericRangeQuery.newDoubleRange("east", w, null, true, true);
				NumericRangeQuery<Double> southRangeQuery = NumericRangeQuery.newDoubleRange("south", null, n, true, true);
				NumericRangeQuery<Double> northRangeQuery = NumericRangeQuery.newDoubleRange("north", s, null, true, true);
